...
export default function App() {
  ...
  return (
    <div className="min-h-screen bg-slate-50/40 font-sans transition-colors duration-300 relative">
      
      {/* Bento Grid Dynamic Ambient Background and blurs */}
      <div className="bento-bg-blur" />
      
      {/* Glow points matching modern visual styles */}
      <div className="absolute top-0 right-0 w-[500px] h-[500px] bg-gradient-to-br from-blue-500/10 to-emerald-500/5 rounded-full blur-3xl pointer-events-none" />
      <div className="absolute top-[20%] left-0 w-[400px] h-[400px] bg-gradient-to-tr from-indigo-500/5 to-emerald-500/5 rounded-full blur-3xl pointer-events-none" />
      ...
      {/* Footer Section */}
      <Footer openIntegrityModal={() => setIsIntegrityModalOpen(true)} />
